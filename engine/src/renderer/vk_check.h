...
namespace renderer
{
    ...
    {
        spdlog::critical("[vulkan] {} failed: {} ({}) at {}:{}",
                         expr, vkResultString(result), static_cast<int>(result), file, line);
    ...
    {
        spdlog::error("[vulkan] {} returned {} ({}) at {}:{}",
                      expr, vkResultString(result), static_cast<int>(result), file, line);
    }
}
...
#define VK_TRY(expr)                                                              \
    do {                                                                          \
        if (VkResult _vk_try_result = (expr);                                     \
            _vk_try_result != VK_SUCCESS) {                                       \
